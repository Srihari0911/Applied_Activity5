...
namespace Applied5
{
    public class SchoolData
    {
        ...
        public SchoolData(string dbPath)
        {
            _dbPath = dbPath;
        }
        ...
        public void AddNewStudent(Student student)
        {
            ...
            {
                StatusMessage = string.Format("Unable to add {0}. Error: {1}", student.Name, ex.Message);
            }
        ...
        public List<Student> GetAllStudents()
        {
            ...
            {
                StatusMessage = string.Format("Unable to retrieve data. {0}", ex.Message);
            }
        ...
        public void AddNewCourse(Course course)
        {
            ...
            {
                StatusMessage = string.Format("Unable to add {0}. Error: {1}", course.Name, ex.Message);
            }
